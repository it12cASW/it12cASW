...
const ClickableArrows = ({ isActive, handleClick, direction, order }) => {
  ...
  const App = () => {
    ...
    const [orderedIssues, setOrderedIssues] = useState(null);
      ...
      <div>
        <div style={styles.fila}>
          <ClickableArrows
            ...
            handleClick={() => {handleClick(0); console.log("Ordenar por type")}}
          ...
          <ClickableArrows
            ...
            handleClick={() => {handleClick(1); console.log("Ordenar por severity")}}
          ...
          <ClickableArrows
            ...
            handleClick={() => {handleClick(2); console.log("Ordenar por priority")}}
          ...
          <ClickableArrows
            ...
            handleClick={() => {handleClick(3);console.log("Ordenar por issue")}}
          ...
          <ClickableArrows
            ...
            handleClick={() => {handleClick(4);console.log("Ordenar por status")}}
          ...
          <ClickableArrows
            ...
            handleClick={() => {handleClick(5);console.log("Ordenar por modified")}}
          ...
          <ClickableArrows
            ...
            handleClick={() => {handleClick(6);console.log("Ordenar por assign to")}}
        ...
        <ShowIssues orderedIssues={orderedIssues} />
      </div>
    );
  };
